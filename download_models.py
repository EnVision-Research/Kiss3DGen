...
redux_flux_lora_pth = hf_hub_download(repo_id="LTT/Kiss3DGen", filename="rgb_normal_redux.safetensors", repo_type="model", local_dir="./checkpoint/flux_lora", local_dir_use_symlinks=False)
